...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>74a45177-1cc2-40d6-b0ba-f44e7889846a</elementGuidId>
...
assertThat(WS.verifyElementPropertyValue(response, 'data.id', '2'))

assertThat(WS.getElementPropertyValue(response, 'data.first_name').equals('Janet'))
