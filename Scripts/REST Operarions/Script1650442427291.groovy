...
def response = WS.sendRequest(findTestObject('REST User Operations/Get User Information'))

WS.verifyResponseStatusCode(response, 200)

response = WS.sendRequest(findTestObject('REST User Operations/PUT update request'))
